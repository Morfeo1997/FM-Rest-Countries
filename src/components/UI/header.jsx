  ...
  return (
    <header className="bg-white dark:bg-Blue-Elements shadow-md px-6 py-4 border-b-4 border-Grey-Background dark:border-Blue-Background transition-colors duration-300">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        >
          <Moon onClick={() => setIsDark(!isDark)} className="w-5 h-5 cursor-pointer stroke-Grey-Text dark:stroke-Grey-Background hover:opacity-80 transition-opacity duration-300" />
